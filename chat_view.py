...
"- Historia y Contexto (RAG): para consultas históricas o contextuales")

# --- Estado de sesión ---
# Dos chat_session separadas: cada pipeline mantiene su propia conversación con Gemini.
if "sql_history" not in st.session_state:
    st.session_state.sql_history = None

if "rag_history" not in st.session_state:
    st.session_state.rag_history = None
    ...
    with st.chat_message("assistant"):
        ...
        if st.session_state.mode == "Estadísticas, Tablas y Gráficos (SQL)":
            with st.spinner("Consultando base de datos..."):
                result = run_pipeline(user_prompt, history=st.session_state.sql_history)
        ...
        # ============================================================
            ...
            with st.spinner("Buscando en fuentes..."):
                result = run_rag_pipeline(user_prompt, history=st.session_state.rag_history)
